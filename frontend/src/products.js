const products = [
  ...
  },
  {
    ...
    description:
      "When young imaginations open the door to the new Barbie Dreamhouse, they'll discover unlimited storytelling possibilities! Standing 43 inches tall and 41 inches wide, this dreamy dollhouse.",
    brand: 'Barbie',
    category: 'Dollhouses',
    price: 239.99,
    countInStock: 0,
